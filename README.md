...
**Probe GridMap Builder** is a lightweight web interface designed for analyzing MD trajectories (in .trr or .nc formats) using AMBER’s cpptraj backend. It enables users to generate grid-based interaction maps between protein structures and solvent probe atoms across dynamic frames. You can use this tool for free by clicking <a href="https://drive.google.com/file/d/14x89Ehda61HUxoY_bQcPqJhTKsd0Zd6R/view?usp=sharing">here</a>. 🔬 Live Demo 👉 [Click here to open the demo interface](https://sean28.github.io/MixMD/blob/gh-pages/probe_gridmap_ui.html)
